...
<head>
 ...
 <style>
      .bg-image {
           background-image: url('assets/img/background-bunga.jpg');
           height: 100vh;
      }
      </style>
...
<div class="container py-5">
        ...
        <div class="text-center">
          <h5>Daftar Akun Baru</h5>
           ...
           <form action="config/aksi_register.php" method="POST">
            ...
            <hr>
            <p>Sudah punya akun? <a href="loginp.hp">Login disini!</a></p>
            </div>
            </div>
            </div>
            </div>
  ...
  <p>&copy; UKK RPL 2024 | Nuraidah</p>
</footer>


<script type="text/javascript" src="assets/js/boststrap.min.js"></script>
</body>
</html>	